...
export const dbKPIPaper = {
   // backgroundImage: 'linear-gradient(217deg, #AE2012, #BB3E03,#EE9B00)',
   boxShadow: '0px 0px 4px 1px gray',
   height: '140px'
}

export const dbKPIName = {
...
export const dbKPIContent = {
   backgroundImage: 'radial-gradient(rgba(255,255,255,1) 0%, rgba(170,170,170,1) 100%)',
   display: 'flex',
   alignItems: 'center',
...
export const dbKPIIcon1 = {
   backgroundImage: 'radial-gradient(rgb(192, 255, 185,0.8) 0%, rgb(91, 233, 66,0.8) 30%, rgb(60, 189, 33,0.8) 60%, rgb(34, 166, 0,0.8) 100%)',
   borderRadius: '50%',
   width: '52px',
   height: '52px',
   display: 'flex',
...
export const dbKPIIcon2 = {
   backgroundImage: 'radial-gradient( rgb(253, 216, 25,0.8) 10%, rgb(232, 5, 5,0.8) 100%)',
   borderRadius: '50%',
   width: '52px',
   height: '52px',
   display: 'flex',
...
export const dbKPIIcon3 = {
   backgroundImage: 'radial-gradient( #52E5E7 10%, #130CB7 100%)',
   borderRadius: '50%',
   width: '52px',
   height: '52px',
   display: 'flex',
...
export const dbKPIDetails = {

}

export const dbKPICash = {
   fontSize: '24px',
   fontWeight: '600',
   textAlign: 'center',
   // marginTop: '20px'
...
export const dbChartDataLayout = {
...
export const dbChartDataName = {
   fontSize: '16px',
   fontWeight: '500'
}

export const dbChartDataCurrency = {
   fontSize: '14px',
   paddingLeft: '10px',
   marginBottom: '14px'
}
